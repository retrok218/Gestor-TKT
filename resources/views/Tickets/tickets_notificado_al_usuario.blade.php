                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 pull-left">   <!--  responsive -->
                            ...
                            <div class="kt-widget24" style="text-align: center;">
                                ...
                                <div class="progress progress--sm" style="height: 1rem">                                                                                            
                                        ...
                                        <div class="progress-bar kt-bg-success barra_progreso" role="progressbar" style= "width: {{$tktporcento}}%" aria-valuenow={{$NotificadoAlUsuario}} aria-valuemin="0" aria-valuemax={{$NotificadoAlUsuario}}></div>                                                                                           
                                </div>              

                            ...
                            <div class="d-flex justify-content-between ">
                                <div class="user-info">
                                    ...
                                    <div class="user-info__basic">
                                        <h6 class="mb-0" style="color: #bc955b;">{{$areas[8]->nombrea}}</h6>									
                                    </div>
                                </div>
                        ...
                        <div class="card bg-white p-3 mb-4 shadow" style="padding: 0.5rem !important; margin-bottom: 0.5rem !important; background-color: #ffffffc7 !important;">                            
                            <div class="d-flex justify-content-between ">
                                <div class="user-info">
                                    ...
                                    <div class="user-info__basic">
                                        <h6 class="mb-0" style="color: #bc955b;">{{$areas[12]->nombrea}}</h6>									
                                    </div>
                                </div>
                        ...
                        <div class="card bg-white p-3 mb-4 shadow" style="padding: 0.5rem !important; margin-bottom: 0.5rem !important; background-color: #ffffffc7 !important;">                            
                            <div class="d-flex justify-content-between ">
                                <div class="user-info">
                                    ...
                                    <div class="user-info__basic">
                                        <h6 class="mb-0" style="color: #bc955b;">{{$areas[14]->nombrea}}</h6>									
                                    </div>
                                </div>

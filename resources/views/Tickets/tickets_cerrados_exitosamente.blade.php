...
<script>
    ...
    var name_tabla = "/datatickets_cerrados_exitosamente";
</script>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 pull-left">   <!--  responsive -->
                            ...
                            <div class="kt-widget24" style="text-align: center;">
                                <div class="row" style="color: #595d6e;">
                                    ...
                                    <div class="col-sm-6" >
                                        <div class="kt-widget25">
                                            ...
                                            <div class="fas fa-ticket-alt fa-spin fa-3x" ></div>
                                                <span class="kt-widget25__stats m-font-brand">- {{$rticket}}</span>                                                  
                                        </div>            
                                    </div>                        
                                </div>  
                                <div class="progress progress--sm" style="height: 1rem">                                                                                            
                                        ...
                                        <div class="progress-bar kt-bg-success barra_progreso" role="progressbar" style= "width: {{$tktporcento}}%" aria-valuenow={{$rticket}} aria-valuemin="0" aria-valuemax={{$rticket}}></div>                                                                                           
                                </div>              

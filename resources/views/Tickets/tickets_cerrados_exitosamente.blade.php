                        ...
                        <div class="col-md-12 col-lg-12 col-xl-3">
                            ...
                            <div class="kt-widget24" style="text-align: center;">
                                ...
                                <div class="progress progress--sm" style="height: 1rem">                                                                                            
                                        ...
                                        <div class="progress-bar kt-bg-success barra_progreso" role="progressbar" style= "width: {{$rticket}}" aria-valuenow={{$rticket}} aria-valuemin="0" aria-valuemax={{$ticket}}></div>                                                                                           
                                </div>              
